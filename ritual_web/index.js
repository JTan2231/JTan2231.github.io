...
function getDB() {
  return new Promise((resolve, _) => {
    ...
    request.onupgradeneeded = function(event) {
      ...
      const eventRequest = event.target;
...
function initDB(initializationCallback) {
...
async function logEntry(setterCallback, entry) {
  ...
  request.onsuccess = function() {
    ...
    setterCallback((entries) => [...entries, entry]);
  };
  request.onerror = function(event) {
    console.error("Error adding data:", event.target.error);
  };
}
async function getAllEntries(setterCallback) {
  const db = await getDB();
  let transaction = db.transaction([STORE_NAMES.entry], "readonly");
  let objectStore = transaction.objectStore(STORE_NAMES.entry);
...
async function getLatestNewsletter(token, entries, setterCallback) {
...
async function generateAndSetNewsletter(token, entries, setterCallback) {
  const db = await getDB();
  let transaction = db.transaction([STORE_NAMES.newsletter], "readonly");
  let objectStore = transaction.objectStore(STORE_NAMES.newsletter);
...
async function getNewsletterIfExists(setterCallback) {
  const db = await getDB();
  let transaction = db.transaction([STORE_NAMES.newsletter], "readonly");
  let objectStore = transaction.objectStore(STORE_NAMES.newsletter);
  let index = objectStore.index("newsletter");
...
function Main() {
  ...
  const [loadingNewsletter, setLoadingNewsletter] = import_react.useState(false);
  const [newsletter, setNewsletter] = import_react.useState(null);
  const [loggedIn, setLoggedIn] = import_react.useState(false);
  const [authToken, setAuthToken] = import_react.useState("");
    ...
    return jsx_dev_runtime.jsxDEV("div", {
      ...
      children: [
        ...
        jsx_dev_runtime.jsxDEV("button", {
          className: "logButton",
          style: { ...baseButtonStyle, margin: "0.5rem 0 1rem 0" },
          onClick: () => {
  ...
  const EntryTable = () => {
    ...
    return jsx_dev_runtime.jsxDEV("div", {
      ...
      children: entries.sort((a, b) => b.createdDate?.getTime() - a.createdDate?.getTime()).map((entry) => jsx_dev_runtime.jsxDEV("div", {
        style: {
        ...
        children: [
          jsx_dev_runtime.jsxDEV("div", {
            ...
            children: jsx_dev_runtime.jsxDEV("span", {
              ...
              children: formatDate(entry.createdDate)
            }, undefined, false, undefined, this)
          }, undefined, false, undefined, this),
          jsx_dev_runtime.jsxDEV("div", {
  ...
  const Loading = ({ complete = false }) => {
    const [dots, setDots] = import_react.useState(1);
    import_react.useEffect(() => {
    ...
    return jsx_dev_runtime.jsxDEV("p", {
      ...
      children: complete ? "" : "Asking GPT" + ".".repeat(dots)
    }, undefined, false, undefined, this);
  };
  const LoginPage = () => {
    const [isExistingUser, setIsExistingUser] = import_react.useState(false);
    const [userChecked, setUserChecked] = import_react.useState(false);
    const typingTimeout = import_react.useRef(null);
    ...
    const getLoginOnClick = () => {
      ...
      const loginFlow = (endpoint, email2, password2) => {
    ...
    return jsx_dev_runtime.jsxDEV("div", {
      ...
      children: [
        ...
        jsx_dev_runtime.jsxDEV("input", {
          ...
          onChange: () => {
            ...
            typingTimeout.current = setTimeout(() => {
              fetch(API_URL + "user-lookup?username=" + document.getElementById("email").value, {
                method: "GET",
                headers: {
                  "Content-Type": "application/json"
                }
        ...
        jsx_dev_runtime.jsxDEV("input", {
          ...
          tabIndex: loginCSSCondition() ? 0 : -1,
          style: {
            width: "100%",
            margin: "0.25rem 0",
        ...
        jsx_dev_runtime.jsxDEV("input", {
          ...
          tabIndex: newAccountCSSCondition() ? 0 : -1,
          style: {
            width: "100%",
            border: 0,
            outline: 0,
        ...
        jsx_dev_runtime.jsxDEV("button", {
          ...
          onClick: getLoginOnClick(),
          children: isExistingUser ? "Login" : "Create Account"
        }, undefined, false, undefined, this),
        jsx_dev_runtime.jsxDEV("div", {
          id: "loginError",
          style: { fontSize: "0.8rem", color: "red", opacity: 0, transition: "0.5s opacity" }
        }, undefined, false, undefined, this)
      ]
    }, undefined, true, undefined, this);
  };
  const NewsletterDisplay = () => {
    import_react.useEffect(() => {
      ...
      let current = newsletter.html;
      let depth = 0;
      let lastRoot = null;
      let stack = [{ node: current, depth, parent: null }];
      const interval = setInterval(() => {
        if (stack.length === 0) {
  ...
  const GetNewsletterButton = () => {
    ...
    if (newsletterDate >= latestSunday) {
      return jsx_dev_runtime.jsxDEV("button", {
        ...
        children: "View last newsletter"
      }, undefined, false, undefined, this);
    } else {
      return jsx_dev_runtime.jsxDEV("button", {
        className: "logButton shining-element",
        style: baseButtonStyle,
        onClick: () => {
          if (!entriesCheck()) {
            return;
          ...
          setLoadingNewsletter(true);
          generateAndSetNewsletter(authToken, entries, (nl) => {
            setNewsletter(nl);
            setLoadingNewsletter(false);
            document.body.style.backgroundColor = nl.color;
          });
        },
        children: "Generate latest newsletter"
      }, undefined, false, undefined, this);
    }
  };
        ...
        children: [
          ...
          jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              ...
              jsx_dev_runtime.jsxDEV(Loading, {
                complete: !loadingNewsletter
              }, undefined, false, undefined, this),
              jsx_dev_runtime.jsxDEV(NewsletterDisplay, {}, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this)
        ]
      }, undefined, true, undefined, this)
    ]
  }, undefined, true, undefined, this) : jsx_dev_runtime.jsxDEV(LoginPage, {}, undefined, false, undefined, this);
}

// src/index.tsx
var jsx_dev_runtime2 = __toESM(require_jsx_dev_runtime(), 1);
var root = client.default.createRoot(document.getElementById("root"));
root.render(jsx_dev_runtime2.jsxDEV(import_react2.default.StrictMode, {
  children: jsx_dev_runtime2.jsxDEV(Main, {}, undefined, false, undefined, this)
}, undefined, false, undefined, this));
